...
public class Student {
    ...
    public int getPtsEarned() { // Returns the total number of points earned (Sum of all the points of the
                                // events the student took part in.)
    ...
    public boolean getAboveFiveEvents() { // checks if the amount of events meet the requirments of 5 non sports and 5
                                          // sport events
